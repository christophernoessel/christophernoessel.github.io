...
const GAZETTEER_DATA = {
 ...
 "locations": [
  ...
  {
   "id": "saferoom_cropland",
   "name": "Saferoom \u2014 Cropland",
   "type": "canon",
   "description": "A small keyed shelter serving the cropland fields. Part of the valley's distributed storm-shelter network; thin canon, one line each in the saferooms handoff.",
   "staff": [],
   "components_produced": [],
   "sounds": [
    "a heavy door"
