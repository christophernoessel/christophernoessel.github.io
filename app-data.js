// Auto-generated from wildhollow_vale.json + editor-placed / camera-projected map hotspot data.
const GAZETTEER_DATA = {
 ...
 "locations": [
  ...
  },
  {
   ...
   "type": "hospitality",
   "description": "Six small stone huts arranged in a half-circle on a low rise east of the compound, each with a single room, a hearth, a desk, a narrow bed, and a small fenced garden. Reserved for wizards working on new spells who need extended residence. Each hut has been warded, repaired, and warded again over the years; the soot patterns on the hearths are not ordinary soot. A statue of Parthemion stands among the huts. Three hammocks, a Vacationer's amenity, sit south of the statue facing Aldermere \u2014 real canon, though not yet modeled in Blender.",
   "staff": [
  ...
  {
   "id": "northrill_farmland",
   "name": "The Northrill Farmland",
   "type": "inferred",
   "description": "Farming sheds scattered along the Northrill as it feeds a shallow valley of fields to the east, with a cottage or two kept for the rare overnight. An old, well-loved tree stands on the bank \u2014 no record of why it's loved, only that it is. Not a settlement; corrected from an earlier misreading of the rendered view that took this for a village.",
   "staff": [],
   "components_produced": [],
   "sounds": [
    "the Northrill running shallow over stone",
    "sheds creaking in the wind"
   ],
   "smells": [
    "cut hay",
    "river damp"
  ...
  {
   "id": "underspire_dam_city",
   "name": "The Underspire",
   "type": "canon",
   "description": "The Goldenhead clan-seat: a working dam holding back Aldermere, with homes, workshops, storerooms, libraries, schoolrooms, archives, and ritual chambers built into and behind its masonry. The Curlspire mill pierces the dam west of center, dividing it into the west arm (the Westwork) and the larger east arm, which houses the Rings and the cottage row. From outside, a visitor sees bermed cottages along the downstream face and the great snail-shell mill above \u2014 the public face of a city built over generations. Not present as its own entry in the live vale.json despite being described as added in a canon-update handoff; assembled here from wildhollow_underspire.md.",
   "staff": [
    "Philiora (matriarch)",
    "the four Goldenhead sub-clans (Brennwick, Holdrun, Marrowgilt, Old Goldenhead)"
   ],
   "components_produced": [],
   "sounds": [
    "rolling-stone doors",
    "clan life muffled behind masonry"
   ],
   "smells": [
    "cold stone",
    "lake damp"
  ...
  {
   "id": "cheese_caves",
   "name": "The Cheese Caves",
   "type": "canon",
   "description": "Two cave mouths cut into the limestone at the foot of the west bluff, a short barrow's walk south-west of the dairy and creamery; a third cave in the same bluff serves as the root cellar. The spring-cooled stone ages the wheels at an even cold year-round. Pernel's family have dug a smial into the bluff beside the cave mouths; Old Eddric keeps the surface cottage and the watch while she works the creamery.",
   "staff": [
    "Pernel Ashcombe (cheesemaker)",
    "Old Eddric (bluff watchman)",
    "Bracken (watch-hound)"
   ],
   "components_produced": [
    "aged cheese wheels",
    "stormcheese (aged through an Ador crossing, unpredictable)"
   ],
   "sounds": [
    "dripping cave damp",
    "Bracken's deep bark at a stranger"
   ],
   "smells": [
    "cold limestone",
    "aging rind"
  ...
  },
  {
   ...
   "name": "The Ice House",
   "type": "inferred",
   "description": "An icehouse near Aldermere's shore, kept by a small crew who read the emberfelt turning orange on the southwest hill as their frost-clock. Thin canon \u2014 known only from a single seasonal-overlay line about the 'icehouse crew's frost-clock'; no dedicated entry or staff detail exists beyond that.",
   "staff": [
    "icehouse crew (unnamed)"
   ],
   "components_produced": [
    "lake ice"
   ],
  ...
  },
  {
   ...
   "name": "The Alderrun",
   "type": "landmark",
   "description": "The valley's main river, flowing from Aldermere's source through the compound and out toward the North Gate. Named for the alders along its banks \u2014 the source of both 'Alderrun' and 'Aldermere.'",
   "staff": [],
   "components_produced": [],
   "sounds": [
    "running water"
  ...
  },
  {
   ...
   "name": "The Westrun",
   "type": "landmark",
   "description": "The eastern branch off the main river, running out to the Guano Caves at Spiderwood's edge.",
   "staff": [],
   "components_produced": [],
   "sounds": [
    "running water"
  ...
  {
   "id": "saferoom_bat_cave",
   "name": "Saferoom \u2014 Bat Caves",
   "type": "canon",
   "description": "A small keyed shelter at the base of the Bat Caves. Part of the valley's distributed storm-shelter network; thin canon, one line each in the saferooms handoff.",
   "staff": [],
   "components_produced": [],
   "sounds": [
    "a heavy door"
  ...
  },
  {
   ...
   "name": "Saferoom \u2014 North",
   "type": "canon",
   "description": "A small keyed shelter beside the Reed Pond, serving anyone working the northern farmland when Ador hits \u2014 the Duck Pond end of the valley is a long run from the gate. Renamed from 'Saferoom \u2014 Cropland' at the proprietor's direction; the Blender object has been renamed to match (Saferoom_North).",
   "staff": [],
   "components_produced": [],
   "sounds": [
    "a heavy door"
  ...
  {
   "id": "saferoom_orchard",
   "name": "Saferoom \u2014 Orchard",
   "type": "canon",
   "description": "A small keyed shelter serving the orchard. Part of the valley's distributed storm-shelter network; thin canon, one line each in the saferooms handoff.",
   "staff": [],
   "components_produced": [],
   "sounds": [
    "a heavy door"
  ...
  {
   "id": "saferoom_pasture",
   "name": "Saferoom \u2014 Pasture",
   "type": "canon",
   "description": "A small keyed shelter serving the pasture. Part of the valley's distributed storm-shelter network; thin canon, one line each in the saferooms handoff.",
   "staff": [],
   "components_produced": [],
   "sounds": [
    "a heavy door"
  ...
  {
   "id": "saferoom_spider_wood",
   "name": "Saferoom \u2014 Spider Wood",
   "type": "canon",
   "description": "A small keyed shelter at Spider Wood\u2019s top gate. Part of the valley's distributed storm-shelter network; thin canon, one line each in the saferooms handoff.",
   "staff": [],
   "components_produced": [],
   "sounds": [
    "a heavy door"
  ...
  },
  {
   ...
   "type": "canon",
   "description": "An abandoned farmstead just downstream of the dam \u2014 a point of interest, not a major center, per the person who actually owns this canon. Distinct from the Westwork (a staffed, active warehouse); this is a separate, disused building cluster.",
   "staff": [],
   "components_produced": [],
   "sounds": [
  ...
  },
  {
   ...
   "type": "inferred",
   "description": "A small stone office near the North Gate, dating from the Crown Period. No gazetteer text exists for it \u2014 this description is a general, invented placeholder based on its name and era, not canon. Likely function: tallying road traffic, tolls, or trade duties passing through the gate, given the period's increased Crown attention to the valley's trade.",
   "staff": [],
   "components_produced": [],
   "sounds": [
    "scratching quills",
    "coin counted onto a table"
   ],
   "smells": [
    "old paper",
    "wax seals"
  ...
  {
   "id": "inner_watch_tower",
   "name": "The Inner Watch Tower",
   "type": "inferred",
   "description": "A tower standing watch over the compound side of the gate approach, distinct from the outward-facing Watchtower. No gazetteer text exists \u2014 general invented placeholder only. Likely function: keeping an eye on the village and road traffic from the inside, complementing the outward watch.",
   "staff": [
    "a watch \u2014 unnamed"
   ],
   "components_produced": [],
  ...
  },
  {
   ...
   "name": "The Watchtower",
   "type": "inferred",
   "description": "A crenellated tower overlooking the north road from outside the gate. No gazetteer text exists \u2014 general invented placeholder only. Likely function: the outward-facing defensive watch, keeping an eye on the road before it reaches the gate itself.",
   "staff": [
    "a watch \u2014 unnamed"
   ],
   "components_produced": [],
   "sounds": [
    "wind at height",
    "a distant bell if trouble is sighted"
   ],
   "smells": [
    "cold stone"
   ]
  ...
  {
   "id": "swimming_jetty",
   "name": "The Swimming Jetty",
   "type": "inferred",
   "description": "A small jetty on Aldermere used for swimming and access to the water. No gazetteer text exists for this \u2014 general invented placeholder, not canon.",
   "staff": [],
   "components_produced": [],
   "sounds": [],
   "smells": []
  ...
  {
   "id": "bat_keeper_cottage",
   "name": "The Bat-Keeper's Cottage",
   "type": "inferred",
   "description": "The bat-keeper's home near the cave mouths. No gazetteer text exists for this \u2014 general invented placeholder, not canon.",
   "staff": [],
   "components_produced": [],
   "sounds": [],
   "smells": []
  ...
  {
   "id": "curing_shed",
   "name": "The Curing Shed",
   "type": "inferred",
   "description": "A shed for curing and processing harvested guano. No gazetteer text exists for this \u2014 general invented placeholder, not canon.",
   "staff": [],
   "components_produced": [],
   "sounds": [],
   "smells": []
  },
  {
   ...
   "name": "The Tray Shed",
   "type": "inferred",
   "description": "Storage for the slatted guano-collection trays. No gazetteer text exists for this \u2014 general invented placeholder, not canon.",
   "staff": [],
   "components_produced": [],
   "sounds": [],
   "smells": []
  },
  {
   ...
   "name": "The Pawl Shed",
   "type": "inferred",
   "description": "Housing for the mechanism securing the cliff-lift at its base. No gazetteer text exists for this \u2014 general invented placeholder, not canon.",
   "staff": [],
   "components_produced": [],
   "sounds": [],
   "smells": []
  },
  {
   ...
   "name": "The Cliff Lift",
   "type": "inferred",
   "description": "A cable lift carrying workers and harvest up and down the bat-cave cliff face. No gazetteer text exists for this \u2014 general invented placeholder, not canon.",
   "staff": [],
   "components_produced": [],
   "sounds": [],
   "smells": []
  ...
  {
   "id": "retreat_shed",
   "name": "The Retreat Shed",
   "type": "inferred",
   "description": "A shelter at the top of the cliff lift, near the stairhead gate. No gazetteer text exists for this \u2014 general invented placeholder, not canon.",
   "staff": [],
   "components_produced": [],
   "sounds": [],
   "smells": []
  ...
  {
   "id": "leaning_stones",
   "name": "The Leaning Stones",
   "type": "inferred",
   "description": "A prehistoric dolmen-and-menhir circle. Thin canon \u2014 the source material notes only that a past magical storm left 'the Asking's truth-pool' here. No gazetteer text exists for this \u2014 general invented placeholder, not canon.",
   "staff": [],
   "components_produced": [],
   "sounds": [],
   "smells": []
  ...
  {
   "id": "parthemion_folly",
   "name": "Parthemion's Folly",
   "type": "canon",
   "description": "A statue among the mage huts, mentioned in the Scholars canon as standing near three hammocks facing Aldermere. Its 'Folly' name and the story behind it aren't detailed in the source material beyond that \u2014 noted here as a real, named feature, not invented, but the deeper lore is thin.",
   "staff": [],
   "components_produced": [],
   "sounds": [],
   "smells": []
  },
  {
   ...
   "name": "The Cidery",
   "type": "inferred",
   "description": "Where the orchard's apple crop is pressed and fermented into cider. No gazetteer text exists for it \u2014 general invented placeholder, not canon.",
   "staff": [],
   "components_produced": [],
   "sounds": [],
   "smells": []
  ...
  {
   "id": "herdsman_cottage",
   "name": "The Herdsman's Cottage",
   "type": "inferred",
   "description": "Home of the herdsman who works the pasture. No gazetteer text exists for it \u2014 general invented placeholder, not canon.",
   "staff": [],
   "components_produced": [],
   "sounds": [],
   "smells": []
  },
  {
   ...
   "name": "The Pig Pen",
   "type": "inferred",
   "description": "A fenced sty and yard for the farm's pigs. No gazetteer text exists for it \u2014 general invented placeholder, not canon.",
   "staff": [],
   "components_produced": [],
   "sounds": [],
   "smells": []
  ...
  {
   "id": "watchman_cottage",
   "name": "The Watchman's Cottage",
   "type": "inferred",
   "description": "Old Eddric's cottage, kept with his dog Bracken, watching over the Cheese Caves. Real canon (wildhollow_creamery_and_cheese.md), reused here as its own map pin.",
   "staff": [],
   "components_produced": [],
   "sounds": [],
   "smells": []
  },
  {
   ...
   "name": "The Dairy",
   "type": "inferred",
   "description": "Where milk is drawn each morning, crossing straight to the creamery. Real canon (wildhollow_creamery_and_cheese.md).",
   "staff": [],
   "components_produced": [],
   "sounds": [],
   "smells": []
  },
  {
   ...
   "name": "The Creamery",
   "type": "inferred",
   "description": "Where the day's milk is turned into cheese by Pernel Ashcombe, before the wheels are carried to the Cheese Caves to age. Real canon (wildhollow_creamery_and_cheese.md).",
   "staff": [],
   "components_produced": [],
   "sounds": [],
   "smells": []
  },
  {
   ...
   "name": "The Duck Pond",
   "type": "inferred",
   "description": "Named in canon via the_clearspan's description (the purifying field protects 'the reed (duck) pond'), but without its own standalone record. Given its own pin here since it's a real, distinct, named feature.",
   "staff": [],
   "components_produced": [],
   "sounds": [],
   "smells": []
  },
  {
   ...
   "name": "The Tool House",
   "type": "inferred",
   "description": "Storage for the farm\u2019s hand tools and implements. No gazetteer text exists for it \u2014 general invented placeholder, not canon.",
   "staff": [],
   "components_produced": [],
   "sounds": [],
   "smells": []
  ...
  {
   "id": "teamster_stable",
   "name": "The Teamster's Stable",
   "type": "inferred",
   "description": "Stabling for the draft teams that pull the farm\u2019s wagons. No gazetteer text exists for it \u2014 general invented placeholder, not canon.",
   "staff": [],
   "components_produced": [],
   "sounds": [],
   "smells": []
  ...
  {
   "id": "loafing_shed",
   "name": "The Loafing Shed",
   "type": "inferred",
   "description": "An open-sided shed where draft animals rest between hauls. No gazetteer text exists for it \u2014 general invented placeholder, not canon.",
   "staff": [],
   "components_produced": [],
   "sounds": [],
   "smells": []
  },
  {
   ...
   "name": "Mogh's Cottage",
   "type": "inferred",
   "description": "A named cottage in the transport yard \u2014 presumably home to a teamster or hand called Mogh. No gazetteer text exists for it \u2014 general invented placeholder, not canon.",
   "staff": [],
   "components_produced": [],
   "sounds": [],
   "smells": []
  },
  {
   ...
   "name": "The Wagon Barn",
   "type": "inferred",
   "description": "Storage and repair space for the farm\u2019s wagons and carts. No gazetteer text exists for it \u2014 general invented placeholder, not canon.",
   "staff": [],
   "components_produced": [],
   "sounds": [],
   "smells": []
  ...
  {
   "id": "cartwright_wheelwright",
   "name": "The Cartwright & Wheelwright's Shop",
   "type": "inferred",
   "description": "Where wagon wheels and cart bodies are built and repaired. No gazetteer text exists for it \u2014 general invented placeholder, not canon.",
   "staff": [],
   "components_produced": [],
   "sounds": [],
   "smells": []
  ...
  {
   "id": "harness_room",
   "name": "The Harness Room",
   "type": "inferred",
   "description": "Storage and repair for draft-team harness and tack. No gazetteer text exists for it \u2014 general invented placeholder, not canon.",
   "staff": [],
   "components_produced": [],
   "sounds": [],
   "smells": []
  },
  {
   ...
   "name": "The Brewhouse",
   "type": "inferred",
   "description": "Mungo's brewhouse, supplying the farm's ale. Real canon (wildhollow_brewhouse_and_ales.md), reused here as its own map pin.",
   "staff": [],
   "components_produced": [],
   "sounds": [],
   "smells": []
  },
  {
   ...
   "name": "The Maltings",
   "type": "inferred",
   "description": "Where grain is malted for the brewhouse, adjoining it directly. No gazetteer text exists for it \u2014 general invented placeholder, not canon.",
   "staff": [],
   "components_produced": [],
   "sounds": [],
   "smells": []
  },
  {
   ...
   "name": "The Granary",
   "type": "inferred",
   "description": "Grain storage on staddle stones, with an owl loft built into the design. No gazetteer text exists for it \u2014 general invented placeholder, not canon.",
   "staff": [],
   "components_produced": [],
   "sounds": [],
   "smells": []
  },
  {
   ...
   "name": "The Receiving Warehouse",
   "type": "inferred",
   "description": "Where incoming goods and trade shipments are received and stored. No gazetteer text exists for it \u2014 general invented placeholder, not canon.",
   "staff": [],
   "components_produced": [],
   "sounds": [],
   "smells": []
  ...
  {
   "id": "apothecary",
   "name": "The Apothecary Annex",
   "type": "inferred",
   "description": "An annex handling the compound's medicinal and alchemical retail trade.",
   "staff": [],
   "components_produced": [],
   "sounds": [],
   "smells": []
  ...
  {
   "id": "drying_lofts",
   "name": "The Drying Lofts",
   "type": "inferred",
   "description": "A set of three drying lofts near the mill, used for curing harvested materials. No gazetteer text exists for it \u2014 general invented placeholder, not canon.",
   "staff": [],
   "components_produced": [],
   "sounds": [],
   "smells": []
  },
  {
   ...
   "name": "The Tannery",
   "type": "inferred",
   "description": "Where hides from the slaughterhouse are cured into leather. No gazetteer text exists for it \u2014 general invented placeholder, not canon.",
   "staff": [],
   "components_produced": [],
   "sounds": [],
   "smells": []
  },
  {
   ...
   "type": "inferred",
   "description": "The compound's slaughter and butchery building.",
   "staff": [],
   "components_produced": [],
   "sounds": [],
   "smells": []
  },
  {
   ...
   "type": "inferred",
   "description": "Woodworking shop with an adjoining timber yard. No gazetteer text exists for it \u2014 general invented placeholder, not canon.",
   "staff": [],
   "components_produced": [],
   "sounds": [],
   "smells": []
  ...
  {
   "id": "workers_cottages",
   "name": "The Workers' Cottages",
   "type": "inferred",
   "description": "Three cottages housing compound workers. No gazetteer text exists for it \u2014 general invented placeholder, not canon.",
   "staff": [],
   "components_produced": [],
   "sounds": [],
   "smells": []
  },
  {
   ...
   "name": "The Hedge",
   "type": "inferred",
   "description": "The bramble hedgerow running the compound's north approach \u2014 blackthorn, then hawthorn, then dog-roses through the seasons. Real canon (wildhollow_flora.md).",
   "staff": [],
   "components_produced": [],
   "sounds": [],
   "smells": []
  ...
  {
   "id": "saferoom_alderrun_ne",
   "name": "Saferoom \u2014 Alderrun NE Bank",
   "type": "canon",
   "description": "A keyed shelter on the northeast bank of the Alderrun at the goods bridge. One of four paired bank shelters added at the proprietor's direction so that no farm worker ever has to ford a river during an Ador crossing \u2014 each bridge has a shelter on both banks. Built in the 3D model this session; not yet written into the canon docs.",
   "staff": [],
   "components_produced": [],
   "sounds": [
    "a heavy door"
  ...
  {
   "id": "saferoom_alderrun_sw",
   "name": "Saferoom \u2014 Alderrun SW Bank",
   "type": "canon",
   "description": "A keyed shelter on the southwest bank of the Alderrun at the goods bridge. One of four paired bank shelters added at the proprietor's direction so that no farm worker ever has to ford a river during an Ador crossing \u2014 each bridge has a shelter on both banks. Built in the 3D model this session; not yet written into the canon docs.",
   "staff": [],
   "components_produced": [],
   "sounds": [
    "a heavy door"
  ...
  {
   "id": "saferoom_northrill_n",
   "name": "Saferoom \u2014 Northrill N Bank",
   "type": "canon",
   "description": "A keyed shelter on the north bank of the Northrill at the keep bridge. One of four paired bank shelters added at the proprietor's direction so that no farm worker ever has to ford a river during an Ador crossing \u2014 each bridge has a shelter on both banks. Built in the 3D model this session; not yet written into the canon docs.",
   "staff": [],
   "components_produced": [],
   "sounds": [
    "a heavy door"
  ...
  {
   "id": "saferoom_northrill_s",
   "name": "Saferoom \u2014 Northrill S Bank",
   "type": "canon",
   "description": "A keyed shelter on the south bank of the Northrill at the keep bridge. One of four paired bank shelters added at the proprietor's direction so that no farm worker ever has to ford a river during an Ador crossing \u2014 each bridge has a shelter on both banks. Built in the 3D model this session; not yet written into the canon docs.",
   "staff": [],
   "components_produced": [],
   "sounds": [
    "a heavy door"
  ...
  "clusters": [
   ...
   },
   {
    ...
    "locations": [
     ...
     "alderrun",
     "duck_pond",
     "saferoom_alderrun_ne",
     "saferoom_alderrun_sw",
     "saferoom_northrill_n",
     "saferoom_northrill_s"
    ],
    "realPositions": {
     "duck_pond": {
      "x": 43.9,
  ...
  "minimap": {
   ...
   "locationPins": [
    ...
    },
    {
     ...
     "x": 79.6,
     "y": 66.1,
     "clusterId": "guano_caves"
    },
    {
     "id": "saferoom_north",
     "x": 20.9,
     "y": 10.8,
     "clusterId": "valley_floor"
    },
    {
     "id": "saferoom_orchard",
     "x": 48.5,
